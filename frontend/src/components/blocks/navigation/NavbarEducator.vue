      ...
      <nav aria-label="main navigation" class="flex h-16 items-stretch justify-between" role="navigation">
        ...
        <ul class="hidden sm:flex items-center gap-x-4">
          <li class="flex items-stretch">
            <RouterLink to="games" class="text-gray-700 hover:text-blue-600 transition-colors">
              View Games
            </RouterLink>
          </li>
          <li class="flex items-stretch">
            <RouterLink to="progress" class="text-gray-700 hover:text-blue-600 transition-colors">
              View Progress
            </RouterLink>
          </li>
          <li class="flex items-stretch">
